...
USAGE
    ...
    %cumRoc3(_yOut,_xPred,_vsLbl,_cutFmt,_dsn,_dir00,_dirOut,_dirPng,_dateOut,_libNm=DEMO,_propOdds=PO,_yOrd=A,_macMode=1,_outCntnts=YES) ;
...
PARAMETERS, Positional
    ...
    _dirOut         Text output subdirectory location
...
PARAMETERS, Keyword with defaults
    ...
    _outCntnts=YES  Request CONTENTS of permanent output datasets
                    DEFAULT: YES
                        YES:    append CONTENTS of permanent output datasets to tabulated results in CUMROC3_&_fileSfx._&_dateOut..TXT
...
%MACRO cumRoc3(_yOut,_xPred,_vsLbl,_cutFmt,_dsn,_dir00,_dirOut,_dirPng,_dateOut,_libNm=DEMO,_propOdds=PO,_yOrd=A,_macMode=1,_outCntnts=YES) ;
