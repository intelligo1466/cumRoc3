...
/* ========================================================================== */
/* TABULATED RESULTS */
    OPTIONS noDATE noNUMBER ORIENTATION= Landscape LINESIZE= 135 ;
...
/* ========================================================================== */
        %IF %UPCASE(&_outCntnts) = YES %THEN %DO ;
            OPTIONS ORIENTATION= Portrait LINESIZE= 95 ;
    ...
    ODS LISTING Close ;
    ODS PROCTITLE ;
    OPTIONS DATE NUMBER ORIENTATION= Portrait LINESIZE= 95 ;
    OPTIONS formDlim= '' ;
